    ...
    return (
        <div>
            <div className='bg-white shadow-2xl rounded-xl w-60 p-3'>
                {
                    img || video ? <div className='p-1 mb-1  text-lg cursor-pointer rounded hover:bg-slate-100 hover:text-[#ee3c4d] font-semibold'>
                ...
                {
                    img || video ? <div className='p-1 text-lg cursor-pointer rounded hover:bg-slate-100 hover:text-[#ee3c4d] font-semibold'>
