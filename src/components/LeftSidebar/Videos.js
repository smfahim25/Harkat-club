...
const Videos = () => {
    ...
    return (
        <div className='mt-10'>
            {isLoading ? <div className='flex flex-col justify-center items-center mt-40'><PicturesLoading /> </div> : <div className='grid grid-cols-3 gap-1'> {club_videos?.results?.map(club_video => <Video key={club_videos.HarkatVideos_id
