                ...
                <div>
                    <fieldset className="w-full space-y-1 ">
                        ...
                        <div className="relative">
                            ...
                            <input type="search" name="Search" placeholder="Search..." className="w-32 py-1 pl-10 text-sm rounded-md sm:w-auto focus:outline-none bg-gray-100  focus:bg-white focus:border-violet-400" />
                        </div>
                    </fieldset>
                </div>
            </div>
