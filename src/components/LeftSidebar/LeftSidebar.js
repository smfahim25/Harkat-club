            ...
            <div className="drawer drawer-mobile h-[720px] 2xl:mr-5 mt-5">
                ...
                <div className={`${styles.keep_scrolling}`}>
                    ...
                    <ul className="menu w-[300px] text-base-content text-[17px]">
                        ...
                        <li><NavLink to='members' className='bg-accent rounded-[20px] h-[30px] hover:bg-neutral hover:text-white mb-2 justify-center'> <BsPeople />Members </NavLink></li>
                        <li><NavLink to='skillavailable' className='bg-accent rounded-[20px] h-[30px] hover:bg-neutral hover:text-white mb-2 justify-center'><span className=""><GiPokecog /> </span>Skills Available</NavLink></li>
